...
bool File_Load_Saved_Game (Checkerboard *saved_board, tetrimino *saved_tetri, tetrimino *saved_que1, tetrimino *saved_que2, tetrimino *saved_held_tetri, int* score, bool *mouse_mode, bool *music_on)
{
    int i, j;
    ...
    else
    {
        ...
        if (fscanf (saved_game, "%d %d %d %d", &saved_que1->x, &saved_que1->y, &saved_que1->type, &saved_que1->direction) != 4)
        {
            fclose (saved_game);
            return FALSE;
        }
        ...
        if (fscanf (saved_game, "%d %d %d %d", &saved_que2->x, &saved_que2->y, &saved_que2->type, &saved_que2->direction) != 4)
        {
            fclose (saved_game);
            return FALSE;
        }
...
void File_Save_Game (Checkerboard *cur_board, tetrimino *cur_tetri, tetrimino *que1, tetrimino *que2, tetrimino *held_tetri, int score, bool mouse_mode, bool music_on)
{
    int i, j;
